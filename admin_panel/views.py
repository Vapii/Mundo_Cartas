...
def admin_compras(request):
    ...
    return render(request, "admin_panel/compras/admin_compras.html", {"compras": compras})
...
def admin_productos(request):
    ...
    return render(request, 'admin_panel/productos/admin_productos.html', {'productos': productos})
...
def admin_usuarios(request):
    ...
    return render(request, 'admin_panel/usuarios/admin_usuarios.html', {'usuario': usuario})
...
def crear_producto(request):
    ...
    return render(request, 'admin_panel/productos/crear_producto.html', {"categorias": categorias})
